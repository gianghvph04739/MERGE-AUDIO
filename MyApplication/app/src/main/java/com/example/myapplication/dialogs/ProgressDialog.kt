...
import com.example.myapplication.ConvertActivity
import com.example.myapplication.R
import com.github.hiteshsondhi88.libffmpeg.FFmpeg
class ProgressDialog : DialogFragment(), ConvertActivity.ProgressPublish {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        ConvertActivity.setProgressListener(this)
